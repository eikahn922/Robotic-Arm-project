...
| `forearm_link.stl` | Binary STL, millimeters | 125.00 × 38.00 × 27.00 mm | Exported as SolidWorks Link #2. The Xacro converts millimeters to meters and applies the STEP-derived transform relative to the upper arm. |
